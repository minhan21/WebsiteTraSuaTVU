...
Console.WriteLine($"Connection string being used: {builder.Configuration.GetConnectionString("WebDataBase")}");
...
//connect database
builder.Services.AddDbContext<WebFashionContext>(options =>
