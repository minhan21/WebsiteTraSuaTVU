...
public partial class WebFashionContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            // This is only a fallback and shouldn't be used since we're configuring in Program.cs
            optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=WebFashion;Trusted_Connection=True;TrustServerCertificate=True");
        }
    }
